...
- 結尾：給後代的詩詞式家書（如古人家訓）
- 只用中文：只有用心尋根的後代才值得讀懂
- 技術：需確保繁體中文字體正確嵌入 PDF

## 譚氏尋根（Tam Family Roots Research）
- **Dedicated research file:** `/workspace/memory/tam_roots.md`
- **Ken's broader life story:** `/workspace/memory/ken_story.md`
- **ALWAYS read both files** when Ken mentions 尋根, family history, grandfather, ancestors, genealogy, or personal stories
- These files accumulate ALL clues and conversations — never summarize or condense them
- Update immediately whenever Ken shares anything meaningful, even in casual conversation
- **Ken's vision:** These files will one day be shared with his children Preston and daughter — a legacy archive
